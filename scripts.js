...
//declares array for each category
  var warm_up = [
    {name: "Running", time: 3},
    {name: "Jump Rope" , time: 5},             {name: "Jumping Jacks", time: 2}];
  var main_workout = [
    {name: "Pushups", time: 1},
    {name: "Crunches" , time: 3},             {name: "Weights", time: 2},
    {name: "Situps", time: 2},
    {name: "Sprints" , time: 4},               {name: "Ladders", time: 2}];
  var cool_down = [
    {name: "Stretches", time: 5},
    {name: "Jogging" , time: 5},               {name: "Tequilas", time: 2}];

//generate random num * length of array
randomWarmUp = warm_up[Math.floor(Math.random() * warm_up.length)];
...
//generate random num * length of array
randomCoolDown =  cool_down[Math.floor(Math.random() * cool_down.length)];
